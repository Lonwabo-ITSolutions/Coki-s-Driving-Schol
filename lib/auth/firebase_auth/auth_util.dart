...
DocumentReference? get currentUserReference =>
    loggedIn ? QuizUsersRecord.collection.doc(currentUser!.uid) : null;

QuizUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : QuizUsersRecord.getDocument(QuizUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
